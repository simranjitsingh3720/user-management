  ...
  const getUserById = useCallback(async (id) => {
    try {
      const params = buildQueryString({
        childFieldsToFetch: `${COMMON_WORDS.ROLE},${COMMON_WORDS.LOCATION},${COMMON_WORDS.LOGIN_TYPE},${COMMON_WORDS.USER_TYPE},${COMMON_WORDS.PRODUCT},${COMMON_WORDS.LOB},${COMMON_WORDS.PRODUCER_TYPE},${COMMON_WORDS.CHANNEL},${COMMON_WORDS.PAYMENT_TYPE},${COMMON_WORDS.PARENT_ID},${COMMON_WORDS.HOUSE_BANK},${COMMON_WORDS.CHILDS},${COMMON_WORDS.PLAN},${COMMON_WORDS.ZONE},${COMMON_WORDS.MASTER_POLICY}`,
        childFieldsEdge: `${COMMON_WORDS.HAS_ROLE},${COMMON_WORDS.HAS_LOCATION},${COMMON_WORDS.HAS_LOGIN_TYPE},${COMMON_WORDS.HAS_USER_TYPE},${COMMON_WORDS.HAS_PRODUCT},${COMMON_WORDS.HAS_LOB},${COMMON_WORDS.HAS_PRODUCER_TYPE},${COMMON_WORDS.HAS_CHANNEL},${COMMON_WORDS.HAS_PAYMENT_TYPE},${COMMON_WORDS.HAS_PARENT_ID},${COMMON_WORDS.HAS_HOUSE_BANK},${COMMON_WORDS.HAS_CHILDS},${COMMON_WORDS.HAS_PLAN},${COMMON_WORDS.HAS_ZONE},${COMMON_WORDS.HAS_MASTER_POLICY}`,
        parentFieldsToFetch: `${COMMON_WORDS.PRODUCER}`,
        parentFieldsEdge: `${COMMON_WORDS.HAS_CHILDS}`,
        id: `${id}`,
      });
